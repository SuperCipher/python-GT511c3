...
modified version by Napat Charuphant <napat_pat3@hotmail.com> on october 2017
noteworthy :
    enroll finger in best picture need more time to process hence need more delay
    before receive package
'''
...
class FPS_GT511C3(SerialCommander):
    ...
    def Identify1_N(self):
        ...
        rp = self.GetResponse()
        retval = rp.IntFromParameter()
        # print "Identify1_N retval", retval
    ...
    def GetResponse(self):
        ...
        '''
        # 0.17 is the minimum for this system
        # INTERVAL = 0.17
        delay(INTERVAL)
